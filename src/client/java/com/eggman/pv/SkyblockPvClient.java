...
import com.eggman.pv.util.PlayerNameCache;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

import com.eggman.pv.gui.GuiProfileViewer;
...
public class SkyblockPvClient implements ClientModInitializer {
	...
	private static void fetchUsers() {
		java.util.concurrent.CompletableFuture.supplyAsync(() -> {
			try { return com.eggman.pv.api.BackendApi.getUsers(); }
