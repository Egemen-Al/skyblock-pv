...
import com.eggman.pv.weight.weight.SlayerWeight;
...
public class LilySlayerWeight extends SlayerWeight {
	...
	public LilySlayerWeight(Map<String, Level> player) {
		super(player);
	}
	...
	public void getSlayerWeight(String slayerName) {
		...
		double scaleFactor = PvCalc.getElementAsFloat(
			PvCalc.getElement(Constants.WEIGHT, "lily.slayer.deprecation_scaling." + slayerName),
			0
		);
